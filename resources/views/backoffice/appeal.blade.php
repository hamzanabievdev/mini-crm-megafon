                            ...
                            <div class="d-flex flex-column align-items-start justift-content-center flex-equal me-5">
                                ...
                                <div class="position-relative w-100">
                                    ...
                                    @if($appeal->status === 'В процессе')
                                        @php
                                            $operatorId = $appeal->operator->id;
                                            $operatorName = $appeal->operator->full_name;
                                        @endphp
                                        <select id="operator_select" class="form-select w-50" data-control="select2" data-current="{{ $operatorId }}" data-placeholder="{{ $operatorName }}">
                                            <option></option>
                                            <option value="{{ $operatorId }}" selected>{{ $operatorName }}</option>
                                    ...
                                    @else
                                        <a class="btn btn-success fw-bold fs-8 fs-lg-base">Назначить ответственного</a>
                                    @endif
                                    <!--end::Action-->
                                </div>
                                <!--end::Input group-->
                ...
                <div class="card mt-8">
                    ...
                    <div class="card-body p-6">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                <textarea id="newCommentMessage" rows="4" class="form-control form-control-solid mb-3" placeholder="Написать комментарий..."></textarea>

                                <div class="d-flex justify-content-end">
                                    <button id="addCommentBtn" class="btn btn-success me-2">Отправить</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--begin::Javascript-->
    ...
    <script src="{{ asset('assets/js/appeals/change.js') }}"></script>
    <style>
    .fade-in {
    ...
    <script src="{{ asset('assets/js/comments/create.js') }}"></script>
<!--end::Javascript-->
@endsection